...
PYTHONPATH=${PROJECT_DIR} python3 t5x/train.py --gin_search_paths=${PROJECT_DIR} --gin_file="t5x/experiments/decoder_52b.gin" --gin.MODEL_DIR=\"${MODEL_DIR}\" --tfds_data_dir=${TFDS_DATA_DIR}
