...
| HARDWARE    | SIZE | SEQ_LEN | TOPOLOGY | DP | TP           | GBS  | N_MICROBATCHES | TOKENS/SEC                                             | SAMPLES/SEC |
| ----------- | ---- | ------- | -------- | -- | ------------ | ---- | -------------- | ------------------------------------------------------ | ----------- |
...
|             |      |         |          |    |              |      |                |                                                        |             |
| TPU v4-1024 | 52b  | 512     | 8x8x8    |    | (4,4,2,1)    | 16   | 0              | 17476.3                                                |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    |    | (8,4,2,1)    | 16   | 0              | 26495.7                                                |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    | 8  | (4, 4, 4, 1) | 24   | 0              |                                                        |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    | 8  | (8,4,2,1)    | 24   | 0              | 26279.4                                                |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    | 8  | (8,4,2,1)    | 48   | 8              | 19787.7                                                |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    | 8  | (8,4,2,1)    | 64   | 8              | 27040.3                                                |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    | 8  | (8,4,2,1)    | 192  | 8              | OOM                                                    |             |
| TPU v4-1024 | 52b  | 1024    | 8x8x8    |    | (8,4,2,1)    | 32   | 0              | OOM       
